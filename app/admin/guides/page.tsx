...
export default function GuidesManagementPage() {
  ...
  const fetchGuides = async () => {
    try {
      const res = await fetch("/api/blog/posts?postType=guide");
  ...
  const handleStatusChange = async (postId: string, newStatus: string) => {
    ...
    try {
      ...
      toast.success(`Guide status changed to ${newStatus.toLowerCase()}`);
      fetchGuides();
    } catch (error) {
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage all category guides</p>
          </div>
          ...
          {filteredPosts.length === 0 ? (
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                {!searchQuery && statusFilter === "all" && (
                  <Link href="/admin/guides/new">
                    <Button>Create First Guide</Button>
                  </Link>
                )}
              </CardContent>
            </Card>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the guide. This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
